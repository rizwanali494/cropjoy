import 'package:cropjoy/ui/feed_back/feedback.dart';
...
class OrderCompletedInfo extends StatelessWidget {
  ...
  const OrderCompletedInfo({super.key,
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  /// use this widget for feedback submitted
                  // Text(
                  //   'Feedback Submitted',
                  //   style: GoogleFonts.inter(
                  ...
                  GestureDetector(
                    onTap: (){
                      Navigator.pushReplacement(
                          context, MaterialPageRoute(builder: (context) => const FeedbackView()));
                    },
                    child: Container(
                      padding: EdgeInsets.symmetric(
                      ...
                      child: Row(
                        children: [
                          Icon(Icons.feedback_outlined, size: screenWidth * 0.045, color: Colors.black),
                          SizedBox(width: 5,),
                          Text(
                            'Submit Feedback',
                            style: GoogleFonts.inter(
